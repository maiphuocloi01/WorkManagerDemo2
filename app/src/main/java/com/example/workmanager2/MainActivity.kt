...
import com.example.workmanager2.worker.CompressingWorker
import com.example.workmanager2.worker.DownloadingWorker
import com.example.workmanager2.worker.FilteringWorker
import com.example.workmanager2.worker.UploadWorker
...
//            .enqueue()
    ...
    private fun setPeriodicWorkRequest() {
        val periodicWorkRequest = PeriodicWorkRequest
            .Builder(DownloadingWorker::class.java, 10000, TimeUnit.MILLISECONDS)
            .build()
